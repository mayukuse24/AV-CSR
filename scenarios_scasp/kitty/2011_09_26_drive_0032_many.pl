...
obj_meta(4, 1, car, pos(-3, 28), lane(current, 1), none).
obj_meta(4, 2, car, pos(0, 25), lane(current, 2), none).
...
obj_meta(5, 1, car, pos(-3, 22), lane(current, 1), none).
obj_meta(5, 2, car, pos(0, 20), lane(current, 2), none).
...
obj_meta(6, 1, car, pos(-3, 17), lane(current, 1), none).
obj_meta(6, 2, car, pos(0, 15), lane(current, 2), none).
...
obj_meta(7, 1, car, pos(-3, 12), lane(current, 1), none).
obj_meta(7, 2, car, pos(0, 11), lane(current, 2), none).
...
obj_meta(8, 1, car, pos(-3, 10), lane(current, 1), none).
obj_meta(8, 2, car, pos(0, 7), lane(current, 2), none).
...
obj_meta(9, 1, car, pos(-3, 12), lane(current, 1), none).
obj_meta(9, 2, car, pos(0, 7), lane(current, 2), none).
...
obj_meta(10, 1, car, pos(-3, 12), lane(current, 1), none).
obj_meta(10, 2, car, pos(0, 9), lane(current, 2), none).
...
obj_meta(11, 1, car, pos(-3, 15), lane(current, 1), none).
obj_meta(11, 2, car, pos(0, 13), lane(current, 2), none).
...
obj_meta(12, 1, car, pos(-3, 15), lane(current, 1), none).
obj_meta(12, 2, car, pos(0, 13), lane(current, 2), none).
obj_meta(12, 3, car, pos(3, 1), lane(current, 1), none).
...
obj_meta(13, 1, car, pos(-6, 12), lane(current, 1), none).
obj_meta(13, 2, car, pos(0, 13), lane(current, 3), none).
obj_meta(13, 3, car, pos(3, 4), lane(current, 2), none).
...
obj_meta(14, 1, car, pos(-6, 9), lane(current, 1), none).
obj_meta(14, 2, car, pos( -3, 16), lane(current, 2), none).
obj_meta(14, 3, car, pos(-3, 6), lane(current, 2), none).
obj_meta(14, 4, truck, pos(3, 19), lane(current, 3), none).
...
obj_meta(15, 1, car, pos(-6, 7), lane(current, 1), none).
obj_meta(15, 2, car, pos(-3, 17), lane(current, 2), none).
obj_meta(15, 3, car, pos(-3, 7), lane(curent, 2), none).
obj_meta(15, 4, truck, pos(0, 19), lane(current, 3), none).
...
obj_meta(16, 1, car, pos(-6, 4), lane(current, 1), none).
obj_meta(16, 2, car, pos(-3, 17), lane(current, 2), none).
obj_meta(16, 3, car, pos(-3, 6), lane(current, 2), none).
obj_meta(16, 4, truck, pos(0, 19), lane(current, 3), none).
obj_meta(16, 5, car, pos(-6, 20), lane(current, 1), none).
...
obj_meta(17, 1, car, pos(-6, 2), lane(current, 1), none).
obj_meta(17, 2, car, pos(-3, 17), lane(current, 2), none).
obj_meta(17, 3, car, pos(-3, 8), lane(current, 2), none).
obj_meta(17, 4, truck, pos(0, 20), lane(current, 3), none).
